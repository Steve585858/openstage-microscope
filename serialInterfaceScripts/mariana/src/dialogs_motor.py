...
class MovingObject(QGraphicsEllipseItem):
    ...
    def mouseMoveEvent(self, event):
        orig_cursor_position = event.lastScenePos() #cursor position
        updated_cursor_position = event.scenePos()

        orig_position = self.scenePos() #Dot position

        updated_cursor_x = updated_cursor_position.x() - orig_cursor_position.x() + orig_position.x() #distance between original and updated
        updated_cursor_y = updated_cursor_position.y() - orig_cursor_position.y() + orig_position.y()
        self.setPos(QPointF(updated_cursor_x, updated_cursor_y)) #update dot
        self.updateMsg()
...
class MotorDialog(QDialog):
    def __init__(self, parent=None, title="Custom Dialog"):
        ...
        iCol += 1
        self.toLeftBtnX = self.createQPushButton('arrowToLeft.png', 1)
        mainLayout.addWidget(self.toLeftBtnX, iRow, iCol,1,1)
        
        iCol += 1
        self.toRightBtnX = self.createQPushButton('arrowToRight.png', 10)
        ...
        iCol += 1
        self.toLeftBtnY = self.createQPushButton('arrowToLeft.png', 20)
        mainLayout.addWidget(self.toLeftBtnY, iRow, iCol,1,1)
        
        iCol += 1
        self.toRightBtnY = self.createQPushButton('arrowToRight.png', 30)
        ...
        iCol += 1
        self.toLeftBtnZ = self.createQPushButton('arrowToLeft.png', 40)
        mainLayout.addWidget(self.toLeftBtnZ, iRow, iCol,1,1)
        
        iCol += 1
        self.toRightBtnZ = self.createQPushButton('arrowToRight.png', 50)
    ...
    def createQPushButton(self, iconFileName, actionId, iconSize=QtCore.QSize(50, 30)): #creates button
        b = QPushButton()
    ...
    async def moveImpl(self, actionId):
        ...
        #self.board.stepper_set_max_speed(motor, 800)
